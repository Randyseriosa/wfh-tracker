...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children, title }) => {
    ...
    const menuItems = [
        { name: 'Dashboard', path: isAdmin ? '/admin' : isSupervisor ? '/supervisor' : '/portal', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
    ];

    if (!isSupervisor) {
        menuItems.push({ name: 'Profile', path: '/profile', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' });
    }
        ...
        <div className="drawer lg:drawer-open min-h-screen bg-base-200/50">
            ...
            <div className="drawer-content flex flex-col items-center justify-start relative p-4 lg:p-8">
                ...
                <div className="w-full flex lg:hidden items-center justify-between mb-8 px-2">
                    ...
                    <h1 className="text-xl font-bold gradient-text">WFH Portal</h1>
            ...
            <div className="drawer-side z-40">
                ...
                <div className="menu p-6 w-80 min-h-full bg-base-100 border-r border-base-300 text-base-content flex flex-col">
                    ...
                    <div className="flex items-center gap-4 px-2 mb-10">
                        ...
                        <div>
                            <h1 className="text-xl font-bold gradient-text">WFH Tracker</h1>
                    ...
                    <div className="mt-auto space-y-4">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm font-medium">{theme === 'nord' ? 'Light Mode' : 'Dark Mode'}</span>
                            </div>
                            <div className="w-8 h-4 bg-base-300 rounded-full relative transition-all group-hover:bg-primary/20">
                                <div className={`absolute top-1/2 -translate-y-1/2 w-3 h-3 rounded-full transition-all duration-300 ${theme === 'nord' ? 'left-1 bg-warning shadow-[0_0_8px_rgba(251,191,36,0.5)]' : 'left-4 bg-primary'}`}></div>
                            </div>
                        </div>
                        ...
                        <div className="p-4 rounded-2xl bg-base-200 border border-base-300 space-y-4">
                            <div className="flex items-center gap-3">
                                <div className="avatar placeholder">
                                    <div className="bg-primary text-white rounded-xl w-10">
                                        <span className="text-sm font-bold">{profile?.name?.charAt(0) || 'U'}</span>
                                    </div>
                                </div>
